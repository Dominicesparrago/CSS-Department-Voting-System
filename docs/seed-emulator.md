...
```powershell
firebase emulators:start --only firestore --project css-department-voting-sy-f46a5
...
```powershell
firebase emulators:exec --only firestore --project css-department-voting-sy-f46a5 "node firebase/seed-emulator.js"
```
...
```powershell
firebase emulators:exec --only firestore --project css-department-voting-sy-f46a5 "node firebase/seed-phase3-test.js"
```
